...
public class TransaccionDiariaJobConfig {
    ...
    public Step cargarTransaccionesWorkerStep(JobRepository jobRepository,
        ...
        return new StepBuilder("cargarTransaccionesWorkerStep", jobRepository)
                ...
                .reader(transaccionItemReader(null, null)) // Los parámetros se inyectan solos por el @StepScope
    ...
    public TaskExecutorPartitionHandler transaccionesPartitionHandler(
            @Qualifier("cargarTransaccionesWorkerStep") Step workerStep,
    ...
    public Step cargarTransaccionesStep(JobRepository jobRepository,
                                        ...
                                        TaskExecutorPartitionHandler transaccionesPartitionHandler) {
        return new StepBuilder("cargarTransaccionesStep", jobRepository)
                .partitioner("cargarTransaccionesWorkerStep", transaccionesPartitioner)
